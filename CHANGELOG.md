...
### Released
- Published **identity-mesh** as a public, portfolio-grade identity governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **identity-mesh**.
...
- That insight became the basis for **identity-mesh**.
